...
function displayUserData(user) {
  // Get the user data using the existing function
  const userData = getDashboardData(user);

  // Update notification count
  document.getElementById("hover-icon1").innerText = userData.notification || 0; // Default to 0 if no notification

  // Update message count
  document.getElementById("hover-icon2").innerText = userData.usermessage || 0; // Default to 0 if no message

  // Update user dropdown
  document.getElementById("user-email").innerText = userData.email || "Email@example.com";
  document.getElementById("user-username").innerText = userData.username || "example";
  document.getElementById("school-name").innerText = userData.schoolname || "example school";
  document.getElementById("school-index").innerText = userData.schoolindex || "e0000";
}
