...
function toggleForms(formIdToShow) {
  ...
  if (dashboard && dashboard.style.display === 'block') {
    console.log("Dashboard is active. Form toggling disabled.");
    return; // Prevent toggling if the dashboard is active
  }
...
function displayDashboard() {
  ...
  const loginFormDiv = document.querySelector(".form-container");
