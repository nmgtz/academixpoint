...
function updateDashboardUI(data) {
  ...
  document.getElementById("alertednotification").textContent = `Hi, ${data.username}: ${note}`;
 document.getElementById("alertedLink").innerHTML = `Open or share this link with your officemates: <a href="${schoolLinkH}${data.schoolindex.toLowerCase()}-teachers-feeding-area.html">${schoolLinkH}${data.schoolindex.toLowerCase()}-teachers-feeding-area.html</a>`;
