...
function updateDashboardUI(data) {
 ...
 document.getElementById("alertedLink").innerHTML = `Open or share this link with your officemates: <a href=`${schoolLinkH}${schoolIndex}-teachers-feeding-area.html`>${schoolLinkH}${schoolIndex}-teachers-feeding-area.html</a>`;
   document.getElementById("sendName").onclick = function() {
     window.location.href = `${schoolLinkH}${schoolIndex}-push-students-names.html`;
   }
document.getElementById("assign-teachers").onclick = function() {
     window.location.href = `${schoolLinkH}${schoolIndex}-push-teachers-names.html`;
   }
