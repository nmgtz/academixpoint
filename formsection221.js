...
<!-- Phone Number Link -->
<li><a href='#user' id='phoneLink'><i class='fas fa-phone fa-lg'>&#160; +255677819173</i></a></li>
...
<div class='contact-popup' id='contact-popup' style="display:none;">
  <div class='contactpop-container'>
    <button id='contactCall1'>Login</button>
    <button id='contactCall2'>Register</button>
  </div>
</div>
