...
// Reinitialize UI after login to ensure buttons work
function initializeDashboardAfterLogin() {
  // Make sure all necessary UI components are shown
  document.getElementById("header").style.display = "none";
  document.getElementById("dashboard").style.display = "block";
  document.getElementById("main-id").style.display = "none";
  document.querySelector(".footer").style.display = "none";
  ...
  // Reinitialize the buttons for notifications and messages
  displayDashboard();
}

// Modify the logout function to reset everything properly
function logout() {
  // Clear session data
  ...
  toggleForms("lg-form"); // Show login form
  document.getElementById("header").style.display = "none";
  document.getElementById("dashboard").style.display = "none";
  document.getElementById("main-id").style.display = "none";
  document.querySelector(".footer").style.display = "none";
  ...
  showMessage("You have been logged out successfully.", true); // Implement `showMessage` to show feedback
}

// Add confirmation message function
function showMessage(message, isSuccess = true) {
  ...
  }, 3000); // Auto-remove the message after 3 seconds
}
