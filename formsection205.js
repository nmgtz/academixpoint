...
function updateDashboardUI(data) {
 ...
 document.getElementById("alertedLink").innerHTML = `Open or share this link with your officemates: <a href="${schoolLinkH}${data.schoolindex}-teachers-feeding-area.html">${schoolLinkH}${data.schoolindex}-teachers-feeding-area.html</a>`;
   document.getElementById("sendName").onclick = function() {
     window.location.href = `${schoolLinkH}${data.schoolindex}-push-students-names.html`;
   }
document.getElementById("assign-teachers").onclick = function() {
     window.location.href = `${schoolLinkH}${data.schoolindex}-push-teachers-names.html`;
   }
