...
const originalText1 = button.textContent;
const originalText2 = button1.textContent;
const originalText3 = button2.textContent;
const originalText4 = button3.textContent;
button.innerHTML = `<i class="fas fa-circle-notch fa-spin"></i>`;
button1.innerHTML = `<i class="fas fa-circle-notch fa-spin"></i>`;
button2.innerHTML = `<i class="fas fa-circle-notch fa-spin"></i>`;
button3.innerHTML = `<i class="fas fa-circle-notch fa-spin"></i>`;
 ...
 if(action === "login") {
 button.innerHTML = originalText1;
    } else if(action === "signup") {
 button1.innerHTML = originalText2;
    } else if(action === "resetPassword") {
 button2.innerHTML = originalText3;
    } else {
      button3.innerHTML = originalText4;
    }
}
      })
      .catch(error => {
...
function displayDashboard() {
    toogleDashboard();
   const userButton = document.getElementById("user-dashboard");
  ...
  userButton.addEventListener("click", (e) => {
    ...
    // Check and toggle the visibility state
