...
function updateDashboardUI(data) {
 ...
 document.getElementById("alertedLink").innerHTML = `Open or share this link with your officemates: <a href="https://www.academixpoint.com/p/teachers-feeding-area.html">https://www.academixpoint.com/p/teachers-feeding-area.html</a>`;
   document.getElementById("sendName").onclick = function() {
     window.location.href = "https://www.academixpoint.com/p/push-students-names.html";
   }
document.getElementById("assign-teachers").onclick = function() {
     window.location.href = "https://www.academixpoint.com/p/push-teachers-names.html";
   }
