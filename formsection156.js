...
async function loadDashboardData() {
  try {
    ...
    // Log the data to check if user details are available
    ...
    if (data.username) {
      ...
      document.getElementById('user-username').textContent = "Username not available";
    }
    ...
    if (data.schoolindex) {
      document.getElementById('school-index').textContent = data.schoolindex;
    } else {
      document.getElementById('school-index').textContent = "School index not available";
    }
