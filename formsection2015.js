...
function toggleForms(formIdToShow) {
  ...
  if (selectedForm.id === "lg-form") {  // Fixed comparison to `id`
    history.pushState(null, "", `/user-logIn?action=logToAccount`);

  } else if (selectedForm.id === "sp-form") {  // Fixed comparison to `id`
    history.pushState(null, "", `/user-registration?action=createAccount`);

  } else if (selectedForm.id === "set-form") {  // Fixed comparison to `id`
    history.pushState(null, "", `/user-reset?action=resetingPassword`);

  } else if (selectedForm.id === "newSet-form") {  // Fixed comparison to `id`
